...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train quality ex-ante predictor")
    parser.add_argument("--dataset", default="results/predictors/datasets/quality_ex_ante_iter2_real_hardened.jsonl")
    parser.add_argument("--meta", default="results/predictors/datasets/quality_ex_ante_iter2_real_hardened_meta.json")
